      ...
      <Suspense>
        {type === "form" ? (
          ...
          <div className="confirmation-subcontainer">
            ...
            <p className="confirmation-message">
              We will confirm your appointment soon! Expect a text from us the
              night before to confirm the date you selected still works! Feel
              free to give us a call or text if you have more questions.
            </p>
            <div className="header-link-container">
              <motion.a
                href="/"
