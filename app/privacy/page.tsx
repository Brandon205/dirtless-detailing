          ...
          <div className="px-6 py-8 sm:px-8 sm:py-12">
            ...
            <div className="prose prose-invert max-w-none">
              ...
              <section className="mb-8">
                ...
                <p className="text-gray-200">
                  Our services are not intended for individuals under the age of 13. We do not knowingly collect personal information from children under 13. If
                  we discover that we have collected information from a child under 13, we will promptly delete such information.
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <div className="bg-blue-900/50 p-6 rounded-lg border border-blue-700/30">
                  <div className="space-y-2 text-gray-200">
                    ...
                    <p>
                      Email:{" "}
                      <a href="mailto:brenden@dirtlessdetailing.com" className="text-blue-300 hover:text-blue-200">
