...
const faqItems = [
    ...
    description: (
      <div>
        <ul style={{ margin: 0 }}>
          ...
          <li>
            Self cleaning properties: Ceramic coatings aggressively bead water, dirt gets caught in these beads and will
            fly off while you're driving!
          </li>
          <li>
            Easier to wash and dry. Dirt washes off easier with less effort, you can also blow dry your vehicle because
  ...
  },
  {
    ...
    description: (
      <p className="faq-description">
        Unfortunately no, but it does noticeably increase resistance against light scratches and swirl marks.
      </p>
    ),
  },
  {
  ...
  },
  {
    ...
    description: (
      <p className="faq-description">
        We never recommend going through a car wash as they can reduce the gloss slickness and beading of your coating
        prematurely. However in a pinch a touchless car wash will suffice. Just make sure to use the cheapest setting,
        without any wax's. It is also recommended after the wash to dry the whole vehicle with supple towels (We
        recommend{" "}
  ...
  },
  {
    ...
    description: (
      <p>
        ...
        page to see all the products and steps that we recommend for a complete wash and decontamination all for under
        $150. You can also ask us about our maintenance services, they don't cost too much per service plus they include
        the interior if you have had any one of our Interior Detail services done before!
      </p>
    ),
  },
];
          ...
          <div style={{ width: "100%" }}>
            <main className="service-main">
              ...
              <div className="service-explain">
                <p>
                  This is our top of the line exterior service. If you want to remove years of wear and scratching, and
                  provide the best protection available, then this is the service for you. We start off with our full{" "}
            ...
            <ol className="list">
              ...
              <li className="item">
                ...
                <div className="step-container">
                  ...
                  <p className="step-desc">
                    Perform our Paint Correction procedure removing up to 85%-90% of scratches and greatly reducing the
                    look of deeper scratches. We also go over the glass as well removing watermarks and fine scratches.
                  </p>
                </div>
              </li>
              <li className="item">
            ...
            <div className="preview-container">
              ...
              <div className="preview-content">
                ...
                <p>
                  See the stunning results that you'll get from our Correct and Protect service, water will be beading
                  straight off of your whole car! Check it out{" "}
                  <a href="/gallery/correct" className="aside-link">
                    here
                  </a>
                  .
