    ...
    <div className="location-container bg-contact">
      ...
      <div className="servicepage-header">
        <div style={{ alignItems: "center" }}>
          ...
          <h2 className="page-subheading" style={{ textAlign: "center" }}>
            Say goodbye to paint imperfections with our paint correction services, and protect your car's finish with our ceramic coatings.
          </h2>
      ...
      <main className="location-main">
        ...
        <div className="text-left">
          <p>
            With our mobile auto detailing services in Milton, we offer a range of services to make your vehicle shine, including interior cleaning, exterior
            washes, ceramic coatings, and paint corrections.
          </p>
