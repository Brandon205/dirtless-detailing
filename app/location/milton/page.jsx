    ...
    <div className="location-container bg-contact">
      ...
      <div className="servicepage-header">
        <div style={{ alignItems: "center" }}>
          <h1>
            <span className="accent-orange bold text-shadow">Milton Detailing Services</span>
          </h1>
          <h2 className="page-subheading" style={{ textAlign: "center" }}>
            Say goodbye to paint imperfections with our paint correction services, and protect your car's finish with
      ...
      <main className="location-main">
        ...
        <div className="text-left">
          <p>
            With our mobile auto detailing services in Milton, we offer a range of services to make your vehicle shine,
            including interior cleaning, exterior washes, ceramic coatings, and paint corrections.
          </p>
          <p>
            Our experienced team uses the latest techniques and products to achieve a flawless finish that will leave
            you amazed.{" "}
          </p>
          <p>
            We take pride in our work and ensure that every detail is taken care of so you can enjoy your car to the
            fullest.
          </p>
        </div>
