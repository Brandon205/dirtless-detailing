    ...
    <div className="location-container bg-contact">
      ...
      <div className="servicepage-header">
        <div style={{ alignItems: "center" }}>
          ...
          <h2 className="page-subheading" style={{ textAlign: "center" }}>
            Protect your car's paint with our ceramic coatings and keep your interior looking brand new with our interior cleaning services.
          </h2>
      ...
      <main className="location-main">
        ...
        <div className="text-left">
          <p>
            Looking for top-notch mobile auto detailing services in Bonney Lake? Look no further than Dirt-Less Detailing! We offer a wide range of services to
            keep your car looking its best, including interior cleaning, exterior washes, ceramic coatings, and paint corrections.
          </p>
          <p>
            Our interior cleaning service will leave your car looking and smelling fresh, while our exterior washes will remove dirt and grime to restore your
            car's shine. But we don't just stop there - our ceramic coatings and paint corrections are designed to provide your car with long-lasting protection
            against the elements, so you can enjoy a pristine finish for years to come. We take pride in our work and always use the best products and
            techniques to achieve outstanding results.
          </p>
          <p>
            Whether you're looking to spruce up your car for a special occasion or simply want to keep it looking its best, our mobile auto detailing services
            in Bonney Lake are the perfect solution. Contact us today to schedule your appointment!
          </p>
        </div>
