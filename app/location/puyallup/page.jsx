...
const jsonld = {
  ...
  "url": "https://www.dirtlessdetailing.com/location/puyallup",
    ...
    <div className="location-container bg-contact">
      ...
      <div className="servicepage-header">
        <div style={{ alignItems: "center" }}>
          <h1>
            <span className="accent-orange bold text-shadow">Vehicle Detailing in Puyallup</span>
          </h1>
          <h2 className="page-subheading" style={{ textAlign: "center" }}>
            Interior • Exterior • Ceramic Coating • Paint Correction. Check out our top auto detailing services for Puyallup Washington!
          </h2>
      ...
      <main className="location-main">
        ...
        <div className="text-left">
          <p>
            Our mobile auto detailing services in Puyallup provide you with a convenient and efficient way to keep your car looking its best without ever having
            to leave your home or office. Our skilled technicians use top-of-the-line equipment and products to ensure that every inch of your vehicle is
            thoroughly cleaned and detailed.
          </p>
          <p>
            For those who want to protect their vehicle from the elements, we offer a 5-year ceramic coating that provides long-lasting protection from
            Washington's weather. Our more in depth exterior detailing services can help restore your vehicle's paint to its original shine and luster, removing
            any unsightly swirls, scratches, or other imperfections.
          </p>
          <p>
            We also offer a wide range of interior cleaning services and add-ons, including deep cleaning, stain removal, and odor elimination. Our team of
            professionals will work tirelessly to ensure that your car's interior is free of dirt, grime, and other unwanted substances.
          </p>
          <p>
            Whether you're looking for a quick exterior wash or a full detailing package, our mobile auto detailing services in Puyallup have you covered.
            Contact us today to schedule an appointment and experience the ultimate in mobile detailing services.
          </p>
        </div>
      ...
      <div className="service-bkg">
        <div style={{ paddingBottom: "2rem" }} className="general-container">
          <h3 className="text-large">Mobile Services offered in Puyallup:</h3>
