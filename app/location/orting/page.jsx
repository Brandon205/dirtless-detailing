    ...
    <div className="location-container bg-contact">
      ...
      <div className="servicepage-header">
        <div style={{ alignItems: "center" }}>
          <h1>
            <span className="accent-orange bold text-shadow">Orting Auto Detailing</span>
          </h1>
          <h2 className="page-subheading" style={{ textAlign: "center" }}>
            Our comprehensive detailing services include everything from exterior washes to ceramic coatings, ensuring that your car looks its best from every
            angle.
          </h2>
      ...
      <main className="location-main">
        ...
        <div className="text-left">
          ...
          <p>
            Our team of experienced detailers will come to you at your convenience, and work efficiently to deliver the highest quality results. Whether you
            need a simple wash or a full detail, we have the tools and expertise to get the job done right.
          </p>
          <p>
            With our affordable prices and exceptional service, you can trust us to keep your vehicle looking like new. Contact us today to schedule your
            appointment!
          </p>
        </div>
