    ...
    <div className="location-container bg-contact">
      ...
      <div className="servicepage-header">
        <div style={{ alignItems: "center" }}>
          ...
          <h2 className="page-subheading" style={{ textAlign: "center" }}>
            Give your car the ultimate makeover with our exterior washes and paint corrections, and ensure long-lasting
            protection with our ceramic coatings.
          </h2>
      ...
      <main className="location-main">
        ...
        <div className="text-left">
          <p>
            If you're looking for a reliable mobile auto detailing service in Buckley, look no further! We offer a
            variety of services to keep your vehicle looking its best.{" "}
          </p>
          <p>
            Our interior cleaning service will leave your car's interior spotless, while our exterior washes will make
            your car shine like new.
          </p>
          <p>
            If you're looking for long-lasting protection, our ceramic coating and paint correction services will give
            your car the protection it needs to stay looking great for years to come.
          </p>
          <p>
            Don't settle for anything less than the best - choose our mobile auto detailing service in Buckley for all
