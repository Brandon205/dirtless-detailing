    ...
    <div className="location-container bg-contact">
      ...
      <div className="servicepage-header">
        <div style={{ alignItems: "center" }}>
          ...
          <h2 className="page-subheading" style={{ textAlign: "center" }}>
            From deep cleaning to odor elimination, our detailing services will leave your car looking and smelling
            fresh.
          </h2>
      ...
      <main className="location-main">
        ...
        <div className="text-left">
          <p>
            Looking for a reliable and professional mobile auto detailing service in Edgewood, Washington? Look no
            further than Dirt-Less Detailing, we offer a range of services to keep your vehicle looking its best.
          </p>
          <p>
            Whether you need a thorough interior cleaning, an exterior wash, or a ceramic coating to protect your paint,
            we have the skills and equipment to get the job done right.
          </p>
          <p>
            Additionally, if your car's paint is showing signs of wear and tear, we can also provide paint correction
            services to restore its shine and luster. Don't settle for a subpar auto detailing service - trust our team
            to keep your car looking like new.
          </p>
        </div>
