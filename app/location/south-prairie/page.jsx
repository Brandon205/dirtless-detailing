    ...
    <div className="location-container bg-contact">
      ...
      <div className="servicepage-header">
        <div style={{ alignItems: "center" }}>
          <h1>
            <span className="accent-orange bold text-shadow">South Prairie Detailing Services</span>
          </h1>
          <h2 className="page-subheading" style={{ textAlign: "center" }}>
            Exterior Washes • Interior Cleaning • Ceramic Coatings. Come see our detailing offers for South Prairie Washington!
          </h2>
      ...
      <main className="location-main">
        ...
        <div className="text-left">
          <p>
            Our mobile auto detailing services in South Prairie offer the ultimate convenience and efficiency, allowing you to maintain your vehicle's pristine
            appearance without ever having to leave your home or office. Our expert technicians use the latest equipment and top-quality products to ensure that
            every inch of your car is thoroughly cleaned and detailed.
          </p>
          <p>
            We provide a range of services, including ceramic coatings and paint corrections, to protect your car's exterior from Washington's unpredictable
            weather. Our interior cleaning services are also available, with options for deep cleaning, stain removal, and odor elimination, ensuring that your
            car's interior is spotless.
          </p>
          <p>
            Whether you need a quick exterior wash or a complete detailing package, our team of professionals is dedicated to delivering the highest level of
            service and satisfaction to every client. Schedule an appointment with our mobile auto detailing services in South Prairie today and experience the
            ultimate in convenience and quality.
          </p>
        </div>
