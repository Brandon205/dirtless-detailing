  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className="w-[350px] max-w-full relative rounded-2xl border border-b-0 flex flex-col justify-center flex-shrink-0 border-neutral-600 px-8 py-6 md:w-[450px]"
            style={{
