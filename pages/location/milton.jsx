        ...
        <div className='location-container bg-contact'>
            ...
            <div className="servicepage-header">
                <div style={{alignItems: 'center'}}>
                    <h1><span className='accent-orange bold text-shadow'>Milton Detailing Services</span></h1>
                    <h2 className='page-subheading' style={{textAlign: 'center'}}>Say goodbye to paint imperfections with our paint correction services, and protect your car's finish with our ceramic coatings.</h2>
