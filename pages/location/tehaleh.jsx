    ...
    return (
        <div className='location-container'>
            <Head>
                ...
                <meta property="og:title" content="Vehicle Detailing in Tehaleh | Dirt-Less Detailing" />
                <meta name="description" content="Interior • Exterior • Ceramic Coating • Paint Correction. Check out our top auto detailing services for Tehaleh Washington" />
                <meta property="og:description" content="Interior • Exterior • Ceramic Coating • Paint Correction. Check out our top auto detailing services for Tehaleh Washington" />
                <meta property="og:type" content="website" />
                <meta property="og:url" content="https://www.dirtlessdetailing.com/location/tehaleh" />
                <meta property="og:image" content={cover.src} />
                <link rel="canonical" href="https://www.dirtlessdetailing.com/location/tehaleh" />
            ...
            <main className="location-main">
                ...
                <div className="text-left">
                    ...
                    <p>If you need one of our more extensive details then our <a href="/location/bonney-lake" className='aside-link'>shop</a> is about 10 minutes away from Tehaleh in Bonney Lake. We can set up an appointment to have you drop it off and once you do you are free to stay or go while we do our work.</p>
                </div>
            ...
            <div className='locationpage-section no-bg'>
                <div>
                    <h3 className='text-large'>Services offered in Tehaleh:</h3>
                    <div className="text-left">
