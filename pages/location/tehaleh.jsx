        ...
        <div className='location-container bg-contact'>
            ...
            <div className="servicepage-header">
                <div style={{alignItems: 'center'}}>
                    <h1><span className='accent-orange bold text-shadow'>Tehaleh Vehicle Detailing Services</span></h1>
                    <h2 className='page-subheading' style={{textAlign: 'center'}}>Ceramic Coatings • Interior • Exterior • Paint Correction services. See our offers for Tehaleh Washington below!</h2>
            ...
            <main className="location-main">
                ...
                <div className="text-left">
                    <p>Our mobile auto detailing services in Tehaleh are designed to keep your vehicle looking its best. We offer a variety of services, including interior cleaning, exterior washes, ceramic coatings, and paint corrections.</p>
                    <p>Whether you need a quick wash or a full detail, our team has you covered. With our attention to detail and commitment to customer satisfaction, you can trust us to provide the best possible results.</p>
                    <p>Plus, we can come to you, so you can enjoy the convenience of our services wherever you are in Tehaleh. Contact us today to schedule an appointment and experience the difference our mobile auto detailing services can make for your vehicle.</p>
                </div>
