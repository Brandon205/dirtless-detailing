        ...
        <div className='location-container bg-contact'>
            ...
            <div className="servicepage-header">
                <div style={{alignItems: 'center'}}>
                    <h1><span className='accent-orange bold text-shadow'>Lake Tapps Vehicle Detailing</span></h1>
                    <h2 className='page-subheading' style={{textAlign: 'center'}}>Give your car the ultimate protection against scratches and other damage with our ceramic coatings, and keep it looking brand new with our exterior washes.</h2>
            ...
            <main className="location-main">
                ...
                <div className="text-left">
                    <p>If you live in Lake Tapps, our mobile detailing services are available to provide you with a variety of cleaning options for your vehicle.</p>
                    <p>Our team of professionals can come to you and offer interior cleaning, exterior washes, ceramic coatings, and paint corrections.</p>
                    <p>We use top-of-the-line equipment and products to ensure your car looks and feels like new again. Contact us today to schedule an appointment and experience the convenience of mobile auto detailing.</p>
                </div>
            ...
            <div className='service-bkg-lighter'>
                <div style={{paddingBottom: '2rem'}} className='general-container'>
                    <h3 className='text-large'>Mobile Services offered in Lake Tapps:</h3>
