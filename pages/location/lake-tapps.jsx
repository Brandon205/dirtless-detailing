...
export default function LakeTapps() {
    return (
        <div className='location-container'>
            <Head>
                <title>Vehicle Detailing in Lake Tapps | Dirt-Less Detailing</title>
                <meta property="og:title" content="Vehicle Detailing in Lake Tapps | Dirt-Less Detailing" />
                <meta name="description" content="Interior • Exterior • Ceramic Coating • Paint Correction. Check out our top auto detailing services for Lake Tapps Washington" />
                <meta property="og:description" content="Interior • Exterior • Ceramic Coating • Paint Correction. Check out our top auto detailing services for Lake Tapps Washington" />
                <meta property="og:type" content="website" />
                <meta property="og:url" content="https://www.dirtlessdetailing.com/location/lake-tapps" />
                <meta property="og:image" content={cover.src} />
                <link rel="canonical" href="https://www.dirtlessdetailing.com/location/lake-tapps" />
                <script type="application/ld+json" key="product-jsonld" dangerouslySetInnerHTML={{
                    __html: `{
                        ...
                        "url": "https://www.dirtlessdetailing.com/location/lake-tapps",
            ...
            <div className="servicepage-header">
                <h1>Mobile Detailing in Lake Tapps Washington</h1>
            ...
            <main className="location-main">
                <h2 className='text-large'>Professional Detailing Services in Lake Tapps Washington.</h2>
                <div className="text-left">
                    <p>Getting a car detailed in Lake Tapps is no problem with our mobile service. We can come to you and perform most of our services at your home or work. If we have permission to detail in the location then we can do it.</p>
                    ...
                    <p>If you need one of our more extensive details then our <a href="/location/bonney-lake" className='aside-link'>shop</a> is about 10 minutes away from Lake Tapps in Bonney Lake. We can set up an appointment to have you drop it off and once you do you are free to stay or go while we do our work.</p>
                </div>
            ...
            <div className='locationpage-section no-bg'>
                <div>
                    <h3 className='text-large'>Services offered in Lake Tapps:</h3>
                    <div className="text-left">
