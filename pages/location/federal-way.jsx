    ...
    <div className="location-container bg-contact">
      ...
      <div className="servicepage-header">
        <div style={{ alignItems: "center" }}>
          <h1>
            <span className="accent-orange bold text-shadow">Vehicle Detailing Federal Way</span>
          </h1>
          <h2 className="page-subheading" style={{ textAlign: "center" }}>
            Keep your car looking showroom-worthy with our exterior washes and protect it from environmental damage with
      ...
      <main className="location-main">
        ...
        <div className="text-left">
          <p>
            Our mobile auto detailing services are now available in Federal Way, and we're thrilled to bring our
            high-quality services to this location.
          </p>
          <p>
            Whether you need an interior cleaning, exterior wash, ceramic coating, or paint correction, our team has the
            expertise and equipment to get the job done right.
          </p>
          <p>
            We understand that life can get busy, so we offer convenient mobile services that can come directly to you,
            whether you're at work or at home.
          </p>
          <p>
            Don't settle for a dirty or lackluster vehicle, let us give your car the attention it deserves with our
