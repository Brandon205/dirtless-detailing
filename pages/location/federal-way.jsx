    ...
    return (
        <div className='location-container'>
            <Head>
                ...
                <meta property="og:title" content="Vehicle Detailing in Federal Way | Dirt-Less Detailing" />
                <meta name="description" content="Interior • Exterior • Ceramic Coating • Paint Correction. Check out our top auto detailing services for Federal Way Washington" />
            ...
            <main className="location-main">
                ...
                <div className="text-left">
                    ...
                    <p>If you need one of our more extensive details then our <a href="/location/bonney-lake" className='aside-link'>shop</a> is about 30 minutes away from Puyallup in Bonney Lake. We can set up an appointment to have you drop it off and once you do you are free to stay or go while we do our work.</p>
                </div>
