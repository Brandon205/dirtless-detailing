...
export default function southPrairie() {
    return (
        <div className='location-container'>
            <Head>
                <title>Vehicle Detailing in South Prairie | Dirt-Less Detailing</title>
                <meta property="og:title" content="Vehicle Detailing in South Prairie | Dirt-Less Detailing" />
                <meta name="description" content="Interior • Exterior • Ceramic Coating • Paint Correction. Check out our top auto detailing services for South Prairie Washington" />
                <meta property="og:description" content="Interior • Exterior • Ceramic Coating • Paint Correction. Check out our top auto detailing services for South Prairie Washington" />
                <meta property="og:type" content="website" />
                <meta property="og:url" content="https://www.dirtlessdetailing.com/location/south-prairie" />
                <link rel="canonical" href="https://www.dirtlessdetailing.com/location/south-prairie" />
            </Head>
            <div className="cover">
            ...
            <main className="location-main">
                <h2 className='text-large'>Professional Detailing Services in South Prairie Washington.</h2>
                <div className="text-left">
                    <p>Getting a car detailed in South Prairie is no problem with our mobile service. We can come to you and perform most of our services at your home or work. If we have permission to detail in the location then we can do it.</p>
                    ...
                    <p>If you need one of our more extensive details then our <a href="/location/bonney-lake" className='aside-link'>shop</a> is only about 10 minutes away from South Prairie in Bonney Lake. We can set up an appointment to have you drop it off and once you do you are free to stay or go while we do our work.</p>
                </div>
            ...
            <div className='locationpage-section no-bg'>
                <div>
                    ...
                    <div className="text-left">
                        ...
                        <a href="/detailing/car-washes" className='aside-link text-medium'>Premium Car Washes</a>
