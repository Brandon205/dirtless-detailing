...
export default function buckley() {
    return (
        <div className='location-container'>
            <Head>
                <title>Vehicle Detailing in Buckley | Dirt-Less Detailing</title>
                <meta property="og:title" content="Vehicle Detailing in Buckley | Dirt-Less Detailing" />
                <meta name="description" content="Interior • Exterior • Ceramic Coating • Paint Correction. Check out our top auto detailing services for Buckley Washington" />
                <meta property="og:description" content="Interior • Exterior • Ceramic Coating • Paint Correction. Check out our top auto detailing services for Buckley Washington" />
                <meta property="og:type" content="website" />
                <meta property="og:url" content="https://www.dirtlessdetailing.com/location/buckley" />
                <link rel="canonical" href="https://www.dirtlessdetailing.com/location/buckley" />
            </Head>
            <div className="cover">
            ...
            <main className="location-main">
                <h2 className='text-large'>Professional Detailing Services in Buckley Washington.</h2>
                <div className="text-left">
                    <p>Getting a car detailed in Buckley is no problem with our mobile service. We can come to you and perform most of our services at your home or work. If we have permission to detail in the location then we can do it.</p>
                    ...
                    <p>If you need one of our more extensive details then our <a href="/location/bonney-lake" className='aside-link'>shop</a> is about 10 minutes away from Buckley in Bonney Lake. We can set up an appointment to have you drop it off and once you do you are free to stay or go while we do our work.</p>
                </div>
            ...
            <div className='locationpage-section no-bg'>
                <div>
                    <h3 className='text-large'>Services offered in Buckley:</h3>
                    <div className="text-left">
