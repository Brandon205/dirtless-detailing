    ...
    return (
        <div className='location-container bg-contact'>
            <Head>
                ...
                <Metatags
                    title='Vehicle Detailing in Edgewood | Dirt-Less Detailing'
                    description='Interior • Exterior • Ceramic Coating • Paint Correction. Check out our top auto detailing services for Edgewood Washington'
            ...
            <div className="servicepage-header">
                <h1>Mobile Detailing in Edgewood Washington</h1>
            ...
            <main className="location-main">
                ...
                <div className="text-left">
                    <p>Getting a car detailed in Edgewood is no problem with our mobile service. We can come to you and perform most of our services at your home or work. If we have permission to detail in the location then we can do it.</p>
                    ...
                    <p>If you need one of our more extensive details then our <a href="/location/bonney-lake" className='aside-link'>shop</a> is about 20 minutes away from Edgewood in Bonney Lake. We can set up an appointment to have you drop it off and once you do you are free to stay or go while we do our work.</p>
                </div>
            ...
            <div className='locationpage-section no-bg'>
                <div>
                    <h3 className='text-large'>Services offered in Edgewood:</h3>
                    <div className="text-left">
