...
export default function Iridium() {
        ...
        case 'wheel':
            content = (
                <div>
                    ...
                    <hr className={styles.cardHr} />
                    <ul className={styles.detailCardUl}>
                        <li key={28} style={{animationDuration: 0.5 + 's'}} className={styles.detailCardLi}>
                            <div className={styles.stepNumberContainer}>
                                <h3 className={styles.stepNumber}>1</h3><div className={styles.verticalRule}></div>
                            </div>
                            <p className={styles.stepDesc}>Wash entire wheel area including wheel barrels, wheels, and tires.</p>
                        </li>
                        <li key={29} style={{animationDuration: 0.9 + 's'}} className={styles.detailCardLi}>
                            <div className={styles.stepNumberContainer}>
                                <h3 className={styles.stepNumber}>2</h3><div className={styles.verticalRule}></div>
                            </div>
                            <p className={styles.stepDesc}>Apply our ceramic coating product to the wheel face.</p>
                        </li>
                    </ul>
                </div>
            )
    ...
    return (
        <div className={styles.bgContact}>
            <Head>
                <title>Iridium Package Details | Dirt-Less Detailing</title>
                ...
                <meta name="twitter:title" content='Iridium Package Details | Dirt-Less Detailing' />
            ...
            <div className={styles.diagonal}>
                <h1 className={styles.textXl}>Our Iridium Package Details</h1>
                <p className={styles.diagonalP}>
                    Our full detailing service topped with a Lifetime Ceramic Coating!
                </p>
            </div>
            ...
            <main style={{marginTop: 10 + 'vh'}} className={styles.serviceMain}>
                <div className={styles.serviceExplain}>
                    <div className={styles.textLeft}>
                        <h2 className={styles.textLarge}>Iridium Package</h2>
                        <p>This package includes everything offered in our <a href="/funnel/gold" className={styles.asideLink}>Gold Package</a>, <a href="/funnel/platinum" className={styles.asideLink}>Platinum Package</a>, and more!</p>
                        <p>Our Iridium Package includes a lifetime ceramic coating, which will protect your car's paint from scratches, fading, and other types of damage for as long as you own your car. The ceramic coating provides a high-gloss finish that enhances the look of your car and is easy to maintain.</p>
                        <p>In addition to the lifetime ceramic coating, our package includes a full interior and exterior wash. We'll remove all dirt, dust, and debris from your car's interior, leaving it smelling fresh and clean. We'll also deep-clean your exterior, from the wheels to the windows, making sure that every surface is spotless.</p>
                        <p>Our team of detailing experts uses the latest tools and techniques to get your car looking and feeling like new again. With our Iridium Package, you'll enjoy the peace of mind that comes with knowing your car is protected by the best ceramic coating on the market and always looks its best.</p>
                        <p>Don't settle for less when it comes to protecting and maintaining your car. Book your Iridium Package appointment today and experience the ultimate protection and detailing experience for your car!</p>
            ...
            <div className={styles.detailsContainer}>    
                <div style={{boxShadow: 'none', margin: 0}} className={styles.card}>
                    <div className={styles.cardHeader}>
                        <a href='/funnel/iridium' className={styles.serviceHeadingLink}><FaCrown style={{color: 'silver' }} /> IRIDIUM PACKAGE</a>
                    ...
                    <ul className={styles.detailsChecklist}>
                        ...
                        <li style={{backgroundColor: service === 'wheel' ? 'gray' : '#80808000', border: service === 'wheel' ? '1px solid white' : 'none'}} onClick={() => setService('wheel')} className={styles.packageChecklistItem}>
                            <AiFillCheckCircle style={{color: 'lightblue'}} className={styles.checkcircle} />
            ...
            <h3 className={`${styles.pricingTitle} ${styles.textWhite}`}>Iridium Package Pricing</h3>
            ...
            <div className={styles.pricingContainer}>
                <div className={`${styles.pricingCard} ${styles.textBlack}`}>
                    ...
                    <p className={`${styles.pricingPrice} ${styles.pricingBorder}`}>$1,699</p>
                ...
                <div className={`${styles.pricingCard} ${styles.textBlack}`}>
                    ...
                    <p className={`${styles.pricingPrice} ${styles.pricingBorder}`}>$1,899</p>
                ...
                <div className={`${styles.pricingCard} ${styles.textBlack}`}>
                    ...
                    <p className={`${styles.pricingPrice} ${styles.pricingBorder}`}>$2,099</p>
