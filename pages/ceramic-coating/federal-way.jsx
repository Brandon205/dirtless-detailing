    ...
    return (
        <div className='bg-contact'>
            <Head>
                ...
                <Metatags
                    title='Ceramic Coating in Federal Way | Dirt-Less Detailing'
                    description='Want a ceramic coating to protect your car in Federal Way? Check out our options and offers on Graphene coatings here.'
                    image='https://imagedelivery.net/6ELuAqAYnn_KvYt8QhJosQ/a5260bdd-11e9-4e31-74ec-c1d75787e000/public'
                    canonical='/ceramic-coating/federal-way'
                />
                <script type="application/ld+json" key="product-jsonld" dangerouslySetInnerHTML={{
                    __html: `{
                        ...
                        "image": "https://imagedelivery.net/6ELuAqAYnn_KvYt8QhJosQ/a5260bdd-11e9-4e31-74ec-c1d75787e000/public",
                        "url": "https://www.dirtlessdetailing.com/ceramic-coating/federal-way/",
                        "offers": [
                            {
                                "@type": "Offer",
                                "priceCurrency": "USD",
            ...
            <div className="servicepage-header">
                <h1>Kenzo Ceramic Coating Installation in Federal Way Washington</h1>
            ...
            <main className="location-main">
                <h2 className='text-large'>Professional Ceramic Coatings in Federal Way Washington.</h2>
                <div className="text-left">
                    ...
                    <p>Our shop is about 20 minutes away from most of Federal Way, once there you are free to go wherever or stick around while we work.</p>
                </div>
                ...
                <h2 className='text-large'>Professional Interior Coatings in Federal Way Washington</h2>
                <div className="text-left">
