    ...
    return (
        <div className='bg-contact'>
            ...
            <main className="location-main">
                <h2 className='text-large'>Professional Ceramic Coatings in Lake Tapps Washington.</h2>
                <div className="text-left">
                    ...
                    <p>Our shop is about 20 minutes away from most of Lake Tapps, once there you are free to go wherever or stick around while we work.</p>
                </div>
                ...
                <h2 className='text-large'>Professional Interior Coatings in Lake Tapps Washington</h2>
                <div className="text-left">
