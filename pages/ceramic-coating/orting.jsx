...
export default function orting() {
    return (
        <div>
            <Head>
                <title>Ceramic Coating in Orting | Dirt-Less Detailing</title>
                <meta property="og:title" content="Ceramic Coating in Orting | Dirt-Less Detailing" />
                <meta name="description" content="Want a ceramic coating to protect your car in Orting? Check out our options and offers on Graphene coatings here." />
                <meta property="og:description" content="Want a ceramic coating to protect your car in Orting? Check out our options and offers on Graphene coatings here." />
                <meta property="og:type" content="website" />
                <meta property="og:url" content="https://www.dirtlessdetailing.com/ceramic-coating/orting" />
                <meta property="og:image" content={cover.src} />
                <link rel="canonical" href="https://www.dirtlessdetailing.com/ceramic-coating/orting" />
                <script type="application/ld+json" key="product-jsonld" dangerouslySetInnerHTML={{
                    __html: `{
                        ...
                        "image": "${cover.src}",
                        "url": "https://www.dirtlessdetailing.com/ceramic-coating/orting/",
                        "offers": [
                            {
                                "@type": "Offer",
                                "priceCurrency": "USD",
            ...
            <main className="location-main">
                <h2 className='text-large'>Professional Ceramic Coatings in Orting Washington.</h2>
                <div className="text-left">
                    ...
                    <p>Our shop is about 20 minutes away from most of Orting, once there you are free to go wherever or stick around while we work.</p>
                </div>
                ...
                <h2 className='text-large'>Professional Interior Coatings in Orting Washington</h2>
                <div className="text-left">
