...
export default function southPrairie() {
    return (
        <div>
            <Head>
                <title>Ceramic Coating in South Prairie | Dirt-Less Detailing</title>
                <meta property="og:title" content="Ceramic Coating in South Prairie | Dirt-Less Detailing" />
                <meta name="description" content="Want a ceramic coating to protect your car in South Prairie? Check out our options and offers on Graphene coatings here." />
                <meta property="og:description" content="Want a ceramic coating to protect your car in South Prairie? Check out our options and offers on Graphene coatings here." />
                <meta property="og:type" content="website" />
                <meta property="og:url" content="https://www.dirtlessdetailing.com/ceramic-coating/south-prairie" />
                <meta property="og:image" content={cover.src} />
                <link rel="canonical" href="https://www.dirtlessdetailing.com/ceramic-coating/south-prairie" />
                <script type="application/ld+json" key="product-jsonld" dangerouslySetInnerHTML={{
                    __html: `{
                        ...
                        "image": "${cover.src}",
                        "url": "https://www.dirtlessdetailing.com/ceramic-coating/south-prairie/",
                        "offers": [
                            {
                                "@type": "Offer",
                                "priceCurrency": "USD",
            ...
            <div className="servicepage-header">
                <h1>Kenzo Ceramic Coating Installation in South Prairie Washington</h1>
            ...
            <main className="location-main">
                <h2 className='text-large'>Professional Ceramic Coatings in South Prairie Washington.</h2>
                <div className="text-left">
                    ...
                    <p>Our shop is about 20 minutes away from most of South Prairie, once there you are free to go wherever or stick around while we work.</p>
                </div>
                ...
                <h2 className='text-large'>Professional Interior Coatings in South Prairie Washington</h2>
                <div className="text-left">
