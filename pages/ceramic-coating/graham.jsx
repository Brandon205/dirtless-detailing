...
export default function graham() {
    return (
        <div>
            <Head>
                <title>Ceramic Coating in Graham | Dirt-Less Detailing</title>
                <meta property="og:title" content="Ceramic Coating in Graham | Dirt-Less Detailing" />
                <meta name="description" content="Want a ceramic coating to protect your car in Graham? Check out our options and offers on Graphene coatings here." />
                ...
                <meta property="og:url" content="https://www.dirtlessdetailing.com/ceramic-coating/graham" />
                <meta property="og:image" content={cover.src} />
                <link rel="canonical" href="https://www.dirtlessdetailing.com/ceramic-coating/graham" />
                <script type="application/ld+json" key="product-jsonld" dangerouslySetInnerHTML={{
                    __html: `{
                        ...
                        "image": "${cover.src}",
                        "url": "https://www.dirtlessdetailing.com/ceramic-coating/graham/",
                        "offers": [
                            {
                                "@type": "Offer",
                                "priceCurrency": "USD",
            ...
            <div className="servicepage-header">
                <h1>Kenzo Ceramic Coating Installation in Graham Washington</h1>
            ...
            <main className="location-main">
                <h2 className='text-large'>Professional Ceramic Coatings in Graham Washington.</h2>
                <div className="text-left">
                    ...
                    <p>Our shop is about 20 minutes away from most of Graham, once there you are free to go wherever or stick around while we work.</p>
                </div>
                ...
                <h2 className='text-large'>Professional Interior Coatings in Graham Washington</h2>
                <div className="text-left">
