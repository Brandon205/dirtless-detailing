        ...
        <div className="App">
            ...
            <header className="home-header">
                ...
                <div className='landing-div'>
                    <h1 className='main-title'>Bonney Lake & Pierce County's<br />Auto Detailing Specialists</h1>
            ...
            <div className="service-bkg" style={{paddingTop: 0}}>
                <div style={{display: screenWidth < 979 ? 'none' : 'flex'}} className="header-icons-container">
                    <div>
                        <Lottie animationData={calendarJSON} lottieRef={calendarRef} style={{width: '70px', gridArea: 'icon'}} loop={2}
                    ...
                    <div>
                        <Lottie animationData={carJSON} lottieRef={carRef} style={{width: '70px', height: '70px', gridArea: 'icon'}} loop={2}
                    ...
                    <div>
                        <Lottie animationData={starJSON} lottieRef={starRef} style={{width: '70px', gridArea: 'icon'}} loop={2}
                    ...
                    <div>
                        <Lottie animationData={mapJSON} lottieRef={mapRef} style={{width: '70px', gridArea: 'icon'}} loop={0}
