...
export default function bonneyLake() {
    return (
        <div>
            <Head>
                <title>Paint Correction in Bonney Lake | Dirt-Less Detailing</title>
                <meta property="og:title" content="Paint Correction in Bonney Lake | Dirt-Less Detailing" />
                ...
                <meta property="og:url" content="https://www.dirtlessdetailing.com/correction/bonney-lake" />
                <meta property="og:image" content={cover.src} />
                <link rel="canonical" href="https://www.dirtlessdetailing.com/correction/bonney-lake" />
                <script type="application/ld+json" key="product-jsonld" dangerouslySetInnerHTML={{
                    __html: `{
                        ...
                        "image": "${cover.src}",
                        "url": "https://www.dirtlessdetailing.com/correction/bonney-lake/",
                        "offers": [
                            {
                                "@type": "Offer",
                                "priceCurrency": "USD",
            ...
            <div className="servicepage-header location-header">
                <h1>Paint Correction in Bonney Lake Washington</h1>
