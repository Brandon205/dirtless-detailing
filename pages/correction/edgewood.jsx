    ...
    return (
        <div className='bg-contact'>
            <Head>
                ...
                <Metatags
                    title='Paint Correction in Edgewood | Dirt-Less Detailing'
                ...
                <script type="application/ld+json" key="product-jsonld" dangerouslySetInnerHTML={{
                    __html: `{
                        ...
                        "image": "https://imagedelivery.net/6ELuAqAYnn_KvYt8QhJosQ/eae0cc31-00b4-4fef-07e3-6dedd1b89200/public",
                        "url": "https://www.dirtlessdetailing.com/correction/edgewood/",
                        "offers": [
                            {
                                "@type": "Offer",
                                "priceCurrency": "USD",
            ...
            <div className="servicepage-header location-header">
                <h1>Paint Correction in Edgewood Washington</h1>
            ...
            <main className="location-main">
                <h2 className='text-large'>Professional Paint Correction in Edgewood Washington.</h2>
                <div className="text-left">
                    ...
                    <p>Our shop is about 20 minutes away from most of Edgewood, these services will take time, but once you are there you are free to go wherever or stick around if needed while we work.</p>
                </div>
