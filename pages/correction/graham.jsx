...
export default function graham() {
    return (
        <div>
            <Head>
                <title>Paint Correction in Graham | Dirt-Less Detailing</title>
                <meta property="og:title" content="Paint Correction in Graham | Dirt-Less Detailing" />
                ...
                <meta property="og:url" content="https://www.dirtlessdetailing.com/correction/graham" />
                <meta property="og:image" content={cover.src} />
                <link rel="canonical" href="https://www.dirtlessdetailing.com/correction/graham" />
                ...
                <script type="application/ld+json" key="product-jsonld" dangerouslySetInnerHTML={{
                    __html: `{
                        ...
                        "image": "${cover.src}",
                        "url": "https://www.dirtlessdetailing.com/correction/graham/",
                        "offers": [
                            {
                                "@type": "Offer",
                                "priceCurrency": "USD",
            ...
            <div className="servicepage-header location-header">
                <h1>Paint Correction in Graham Washington</h1>
            ...
            <main className="location-main">
                <h2 className='text-large'>Professional Paint Correction in Graham Washington.</h2>
                <div className="text-left">
                    ...
                    <p>Our shop is about 30 minutes away from most of Graham, these services will take time, but once you are there you are free to go wherever or stick around if needed while we work.</p>
                </div>
