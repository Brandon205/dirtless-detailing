    ...
    return (
        <div className='bg-contact'>
            ...
            <main className="location-main">
                <h2 className='text-large'>Professional Paint Correction in Buckley Washington.</h2>
                <div className="text-left">
                    ...
                    <p>Our shop is about 10 minutes away from most of Buckley, these services will take time, but once you are there you are free to go wherever or stick around if needed while we work.</p>
                </div>
