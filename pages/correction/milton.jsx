...
export default function milton() {
    return (
        <div>
            <Head>
                <title>Paint Correction in Milton | Dirt-Less Detailing</title>
                <meta property="og:title" content="Paint Correction in Milton | Dirt-Less Detailing" />
                ...
                <meta property="og:url" content="https://www.dirtlessdetailing.com/correction/milton" />
                <meta property="og:image" content={cover.src} />
                <link rel="canonical" href="https://www.dirtlessdetailing.com/correction/milton" />
                <script type="application/ld+json" key="product-jsonld" dangerouslySetInnerHTML={{
                    __html: `{
                        ...
                        "image": "${cover.src}",
                        "url": "https://www.dirtlessdetailing.com/correction/milton/",
                        "offers": [
                            {
                                "@type": "Offer",
                                "priceCurrency": "USD",
            ...
            <main className="location-main">
                <h2 className='text-large'>Professional Paint Correction in Milton Washington.</h2>
                <div className="text-left">
                    ...
                    <p>Our shop is about 25 minutes away from most of Milton, these services will take time, but once you are there you are free to go wherever or stick around if needed while we work.</p>
                </div>
