          ...
          <div style={{width: '100%'}}>
            <main className="service-main">
              ...
              <div className="service-explain">
                ...
                <p><span className='special-package'>NOTE:</span> Please note that this is not a deep cleaning service but rather a targeted approach to sprucing up your vehicle's interior.If you are looking for a more in depth thorough interior detailing experience, take a look at our <a href="/interior" className='aside-link'>Full Interior Detail</a>!</p>
              </div>
            </main>
            ...
            <div>
              ...
              <PricingComponent prices={[150, 150, 150, 175, 175, 200]} addons={[addons.ozone]} />
            </div>
