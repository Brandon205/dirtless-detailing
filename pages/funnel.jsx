            ...
            <div className={styles.reviewsContainer}>
                <div className={styles.reviewCard}>
                    ...
                    <div className={styles.reviewTop}>
                        ...
                        <p>Services: <span className={styles.subtext}>Wheel washing, Paint repair, Auto interior vacuuming, Auto detailing, Full body wash, Car waxing</span></p>
                    </div>
                ...
                <div className={styles.reviewCard}>
                    ...
                    <div className={styles.reviewTop}>
                        ...
                        <strong className={styles.review}>★★★★★</strong>
                        <p>Services: <span className={styles.subtext}>Full body wash, Car waxing, Headlight polishing, Auto detailing, Paint repair, Exhaust tip polishing, Clay bar treatment, Wheel washing</span></p>
                    </div>
                    <div className={styles.reviewBottom}>
                ...
                <div className={styles.reviewCard}>
                    ...
                    <div className={styles.reviewTop}>
                        ...
                        <strong className={styles.review}>★★★★★</strong>
                        <p>Services: <span className={styles.subtext}>Engine detailing, Auto interior vacuuming, Full body wash, Car waxing, Auto detailing, Interior scenting, Exhaust tip polishing, Steam cleaning, Seat shampooing, Clay bar treatment, Wheel washing</span></p>
                    </div>
                    <div className={styles.reviewBottom}>
