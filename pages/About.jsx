...
export default function About() {
  ...
  const negativeYMovement = useTransform(
    scrollY.scrollYProgress,
    [0, 0.32],
    [0, -30]
  )
    ...
    <div className='App bg-contact'>
      ...
      <div className="servicepage-header">
        <div style={{alignItems: 'center'}}>
          ...
          <h2 className='page-subheading' style={{textAlign: 'center'}}>Learn a little more about us at Dirt-Less Detailing and why we began doing what we do.</h2>
      ...
      <section style={{lineHeight: '2', fontSize: '1.2em'}} className="about-container">
        <div className="about-explain">
          ...
          <div className="text-left">
            ...
            <p>Starting almost a decade ago as a detailer at a autobody shop, I started Dirt-Less Detailing to bring what I learned from that to everybody near Bonney Lake.</p>
