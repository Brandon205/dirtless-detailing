    ...
    <section className="popular-container">
        <div className="popular-services-card">
            ...
            <div className='popular-img'>
                <Image style={{borderRadius: '1rem 1rem 0 0'}} src={interior} alt="car interior before and after" priority quality={25} />
            </div>
        ...
        <div className="popular-services-card">
            ...
            <div className="popular-img">
                <Image style={{borderRadius: '1rem 1rem 0 0'}} src={dlWash} alt="car exterior" priority quality={25} />
            </div>
        ...
        <div className="popular-services-card">
            ...
            <div className="popular-img">
                <Image style={{borderRadius: '1rem 1rem 0 0'}} src={paint} alt="paint correction before and after" priority quality={25} />
            </div>
