...
export function ServiceType({serviceType, interior, exterior, addons, dogHair, dirtiness, vehicleSize, updateFields }) {
    let content;
    if (serviceType === 'Interior') {
            ...
            <div className="service-type-container">
                ...
                <div style={{justifyContent: 'center', gap: '1rem'}}>
                    <div className="label-container">
                        ...
                        <label htmlFor="little or none" className='dirty-label' style={{color: 'green'}}>Little or None <span className='special-package italic'>($0)</span></label>
                    </div>
                    <div className="label-container">
                        ...
                        <input type="checkbox" name="dogHair" id="medium amount" value="Medium Amount" className='radio-button' onChange={(e) => updateFields({dogHair: e.target.value})} checked={dogHair === "Medium Amount"} />
                        <label htmlFor="medium amount" className='dirty-label' style={{color: 'yellow'}}>Medium Amount <span className='special-package italic'>($50)</span></label>
                    </div>
                    <div className="label-container">
                        ...
                        <input type="checkbox" name="dogHair" id="lots of hair" value="Lots of Hair" className='radio-button' onChange={(e) => updateFields({dogHair: e.target.value})} checked={dogHair === "Lots of Hair"} />
                        <label htmlFor="lots of hair" className='dirty-label' style={{color: 'red'}}>Tons of Hair <span className='special-package italic'>($100)</span></label>
                    </div>
                </div>
                ...
                <div style={{justifyContent: 'center', gap: '1rem'}}>
                    <div className="label-container">
                        ...
                        <label htmlFor="pretty clean" className='dirty-label' style={{color: 'green'}}>Pretty Clean <span className='special-package italic'>($0)</span></label>
                    </div>
                    <div className='label-container'>
                        ...
                        <input type="checkbox" name="dirtiness" id="normal use" value="Normal Use" className='radio-button' onChange={(e) => updateFields({dirtiness: e.target.value})} checked={dirtiness === "Normal Use"} />
                        <label htmlFor="normal use" className='dirty-label' style={{color: 'yellow'}}>Normal Use <span className='special-package italic'>($0)</span></label>
                    </div>
                    <div className="label-container">
                        ...
                        <input type="checkbox" name="dirtiness" id="extremely dirty" value="Extremely Dirty" className='radio-button' onChange={(e) => updateFields({dirtiness: e.target.value})} checked={dirtiness === "Extremely Dirty"} />
                        <label htmlFor="extremely dirty" className='dirty-label' style={{color: 'red'}}>Extremely Dirty <span className='special-package italic'>($0)</span></label>
                    </div>
                </div>
                ...
                <label htmlFor="ozone" className='checkbox-label'>Ozone Treatment <span className='special-package italic'>($75)</span></label>
            </div>
        )
        ...
        content = (
            <div className="service-type-container">
                ...
                <label htmlFor="exterior" className='checkbox-label'>Exterior Decon Wash <span className='special-package italic'>(${prices[vehicleSize].exterior.exteriorwash})</span></label>
                ...
                <label htmlFor="exterior-seal" className='checkbox-label'>Exterior Seal and Shine <span className='special-package italic'>(${prices[vehicleSize].exterior.exteriorseal})</span></label>
                ...
                <label htmlFor="exterior-correct" className='checkbox-label'>Exterior Correct and Protect <span className='special-package italic'>(${prices[vehicleSize].exterior.exteriorcorrect})</span></label>
                ...
                <label htmlFor="engine-bay" className='checkbox-label'>Engine Bay Cleaning <span className='special-package italic'>($75)</span></label>
            </div>
        )
            ...
            <div className="service-type-container">
                ...
                <div style={{justifyContent: 'center', gap: '1rem'}}>
                    ...
                    <div className="label-container">
                        <div style={{backgroundImage: `url('https://imagedelivery.net/6ELuAqAYnn_KvYt8QhJosQ/f06c6b85-4960-420b-0948-e14d69910a00/public')`}} className="label-image"></div>
                        <input type="checkbox" name="dirtiness" id="extremely dirty" value="Extremely Dirty" className='radio-button' onChange={(e) => updateFields({dirtiness: e.target.value})} checked={dirtiness === "Extremely Dirty"} />
                        <label htmlFor="extremely dirty" className='dirty-label' style={{color: 'red'}}>Very Dirty <span className='special-package italic'>($0)</span></label>
                    </div>
                </div>
                ...
                <label htmlFor="interior-addon" className='checkbox-label'>Ozone Treatment <span className='special-package italic'>($75)</span></label>
                ...
                <label htmlFor="exterior-addon" className='checkbox-label'>Engine Bay Cleaning <span className='special-package italic'>($75)</span></label>
            </div>
