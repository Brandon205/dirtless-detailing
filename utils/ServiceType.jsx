    ...
    if (serviceType === 'Interior') {
        content = (
            <div>
                ...
                <h3>Add-ons</h3>
                <input type="checkbox" name="interior-addons" id="ozone" value="Ozone Treatment" className='radio-button' checked={addons.includes('Ozone Treatment')} onChange={(e) => updateFields({interior: e.target.value})} />
        ...
        content = (
            <div>
                <input type="checkbox" name="exterior" id="exterior" value="Exterior" className='radio-button' checked={exterior === "Exterior"} onChange={(e) => updateFields({exterior: e.target.value})} />
                ...
                <label htmlFor="interior-spill" className='checkbox-label'>Exterior Seal and Shine</label>
                ...
                <label htmlFor="interior-spill" className='checkbox-label'>Exterior Correct and Protect</label>
        ...
        content = (
            <div>
                ...
                <input type="checkbox" name="exterior" id="exterior-seal" value="Interior + Spill" className='radio-button' checked={exterior === "Exterior Seal"} onChange={(e) => updateFields({exterior: e.target.value})} />
                <label htmlFor="interior-spill" className='checkbox-label'>Exterior Seal and Shine</label>

                <input type="checkbox" name="exterior" id="exterior-correct" value="Interior + Spill" className='radio-button' checked={exterior === "Exterior Correct"} onChange={(e) => updateFields({exterior: e.target.value})} />
                <label htmlFor="interior-spill" className='checkbox-label'>Exterior Correct and Protect</label>
                ...
                <label htmlFor="interior-addon" className='checkbox-label'>Engine Bay Cleaning</label>

                <input type="checkbox" name="both-addons" id="exterior-addon" value="Engine Bay" className='radio-button' checked={addons.includes('Engine Bay')} onChange={(e) => updateFields({interior: e.target.value})} />
