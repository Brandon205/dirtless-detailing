export function BasicInfo({ name, email, phone, year, make, model, gift, message, updateFields }) {
  ...
  return (
    <div className="form-section">
      ...
      <p style={{ display: gift === "Myself" ? "none" : "block" }} className="contact-subheading">
        *When buying a gift certificate for someone else fill out YOUR contact information, but THEIR vehicle
        information (or as much as you know about their vehicle). We'll then get in contact with you to get the gift
        card to you!
      </p>
      <div style={{ margin: "0 auto" }} className="basic-info-container">
        <input
          ...
          id="myself"
          value="Myself"
          onChange={(e) => updateFields({ gift: e.target.value })}
          checked={gift === "Myself"}
          className="radio-button"
        />
        <label htmlFor="myself" className="checkbox-label">
          For Myself
        </label>
      ...
      <div style={{ marginBottom: 0 }} className="basic-info-container">
        <div style={{ position: "relative", display: "flex", justifyContent: "flex-start" }}>
          <label htmlFor="name" className="text-input-label">
            Name<span className="special-package">*</span>
          </label>
          <input
            type="text"
            id="name"
        ...
        <div style={{ position: "relative", display: "flex", justifyContent: "flex-start" }}>
          <label htmlFor="email" className="text-input-label">
            Email<span className="special-package">*</span>
          </label>
          <input
            type="email"
            id="email"
        ...
        <div style={{ position: "relative", display: "flex", justifyContent: "flex-start" }}>
          <label htmlFor="phone" className="text-input-label">
            Phone Number<span className="special-package">*</span>
          </label>
          <input
            type="tel"
            id="phone"
      ...
      <div style={{ marginBottom: "2rem" }} className="basic-info-container">
        <div className="select-field">
          <label htmlFor="year" className="text-input-label">
            Year<span className="special-package">*</span>
          </label>
          <select
            id="year"
            name="year"
        ...
        <div className="select-field">
          <label htmlFor="make" className="text-input-label">
            Make<span className="special-package">*</span>
          </label>
          <select
            id="make"
            name="make"
            className="text-input make-input"
            value={make}
        ...
        <div style={{ position: "relative", display: "flex", justifyContent: "flex-start" }} className="select-field">
          <label htmlFor="model" className="text-input-label">
            Model<span className="special-package">*</span>
          </label>
          <input
            type="text"
            id="model"
            name="model"
            className="text-input model-input"
            value={model}
      ...
      <div style={{ width: 100 + "%", position: "relative", marginTop: "2rem" }}>
        <label htmlFor="message" style={{ bottom: "130px" }} className="text-input-label">
        ...
        <textarea
          ...
          placeholder="Do you want our mobile service or to schedule a drop off at our shop? Do you have any other questions/concerns for us?"
        />
      </div>
    </div>
  );
